<template>
  <header>
    <div class="ui secondary menu">
      ...
      <div class="item">
        <div class="ui header">
          <div class="content">Конструктор договоров (Администратор)</div>
        </div>
      </div>
  ...
  <aside>
    <div class="ui secondary lightyellow vertical menu">
      <a class="item active">
        <div class="flex centering relaxed">
          <span class="ui fluid text">Шаблоны</span>
          <i class="large copy outline icon"></i>
        </div>
      </a>
      <a class="item">
        <div class="flex centering relaxed">
          <span class="ui fluid text">Справочники</span>
  ...
  <main>
    ...
    <transition name="fade" mode="out-in">
      <div class="white absolute" v-if="activeDoc">
        <CsDocument :data="activeDoc" @close="activeDoc = null" />
      </div>
    </transition>
  </main>
</template>
